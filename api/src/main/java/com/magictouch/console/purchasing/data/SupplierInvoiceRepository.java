...
@ApplicationScoped
public class SupplierInvoiceRepository implements PanacheRepository<SupplierInvoice> {

    public PanacheQuery<SupplierInvoice> search(long profileId, long supplierId, boolean archived,
