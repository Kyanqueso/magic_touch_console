...
import com.magictouch.console.purchasing.domain.SupplierInvoiceService;
...
public class SupplierInvoiceResource {
    ...
    public SupplierInvoiceResource(SupplierInvoiceService service) {
        this.service = service;
    }

    @GET
    public PageResponse<SupplierInvoiceSummaryRow> list(
    ...
    @GET
    @Path("{id}")
    public SupplierInvoiceResponse get(@PathParam("profileId") long profileId,
                                       @PathParam("supplierId") long supplierId,
    ...
    public Response create(@PathParam("profileId") long profileId,
                           @PathParam("supplierId") long supplierId,
                           @Valid SupplierInvoiceRequest body, @Context UriInfo uriInfo) {
        SupplierInvoiceResponse created = service.create(profileId, supplierId, body);
        return Response
    ...
    @Path("{id}")
    @Consumes(MediaType.APPLICATION_JSON)
    public SupplierInvoiceResponse update(@PathParam("profileId") long profileId,
                                          @PathParam("supplierId") long supplierId,
                                          @PathParam("id") long id, @Valid SupplierInvoiceRequest body) {
