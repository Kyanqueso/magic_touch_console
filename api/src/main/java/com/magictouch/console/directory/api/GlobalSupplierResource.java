...
/** Global suppliers — not scoped to a corporate profile. Mirrors {@link SupplierResource}. */
@Path("/api/v1/suppliers")
@Produces(MediaType.APPLICATION_JSON)
@Tag(name = "Suppliers")
public class GlobalSupplierResource {

    private final SupplierService service;

    public GlobalSupplierResource(SupplierService service) {
